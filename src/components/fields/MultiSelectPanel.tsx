    ...
    <div className="space-y-6">
      <div className="space-y-3">
        ...
        <div className="grid grid-cols-2 gap-2">
          <button
            ...
            className="flex flex-col items-center gap-1.5 p-2 rounded-lg bg-zinc-900 hover:bg-zinc-800 border border-zinc-800 transition-colors"
            title="Match Width"
          >
      ...
      <div className="space-y-3">
        ...
        <div className="grid grid-cols-3 gap-2">
          <button onClick={() => handleAlign('left')} className="p-2 rounded-lg bg-zinc-900 hover:bg-zinc-800 border border-zinc-800 flex justify-center transition-colors" title="Align Left">
            <AlignLeft className="w-4 h-4 text-zinc-400" />
          </button>
          <button onClick={() => handleAlign('center')} className="p-2 rounded-lg bg-zinc-900 hover:bg-zinc-800 border border-zinc-800 flex justify-center transition-colors" title="Align Center">
            <AlignCenter className="w-4 h-4 text-zinc-400" />
          </button>
          <button onClick={() => handleAlign('right')} className="p-2 rounded-lg bg-zinc-900 hover:bg-zinc-800 border border-zinc-800 flex justify-center transition-colors" title="Align Right">
            <AlignRight className="w-4 h-4 text-zinc-400" />
          </button>
          <button onClick={() => handleAlign('top')} className="p-2 rounded-lg bg-zinc-900 hover:bg-zinc-800 border border-zinc-800 flex justify-center transition-colors" title="Align Top">
            <AlignRight className="w-4 h-4 text-zinc-400 -rotate-90" />
          </button>
          <button onClick={() => handleAlign('middle')} className="p-2 rounded-lg bg-zinc-900 hover:bg-zinc-800 border border-zinc-800 flex justify-center transition-colors" title="Align Middle">
            <AlignCenter className="w-4 h-4 text-zinc-400 rotate-90" />
          </button>
          <button onClick={() => handleAlign('bottom')} className="p-2 rounded-lg bg-zinc-900 hover:bg-zinc-800 border border-zinc-800 flex justify-center transition-colors" title="Align Bottom">
      ...
      <div className="space-y-3">
        ...
        <div className="grid grid-cols-2 gap-2">
          <button
            ...
            className="flex flex-col items-center gap-1.5 p-2 rounded-lg bg-zinc-900 hover:bg-zinc-800 border border-zinc-800 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
